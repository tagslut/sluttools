...
from config import ensure_config_exists, get_auto_match_threshold, load_config
from rich.console import Console
from rich.panel import Panel
from rich.prompt import Prompt

# Import our modules
from transparent_matching import batch_match_entries, get_flac_lookup, refresh_library
...
async def main():
    ...
    console.print(
        f"[cyan]Loaded {len(flac_lookup)} tracks from library database[/cyan]"
    )
